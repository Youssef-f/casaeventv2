...
export default function EventDetail() {
  ...
  const allEvents = [
    {
      id: "1",
      name: "Samedi 21 Juin (Gay Concert) - Gims",
      description: "Un concert exceptionnel avec Gims à Casablanca!",
      eventDate: "2025-06-21T14:00:00Z",
      location: "Parc de la ligue Arabe",
      price: 600,
      imageUrl: "/images/gims.jpg",
      posterUrl: "/images/gims.jpg",
      availability: { totalTickets: 1000, purchasedCount: 200 },
      position: [33.5731, -7.5898],
    },
    {
      id: "2",
      name: "CASANOLA - Festival de Jazz",
      description: "Le festival de jazz incontournable de Casablanca!",
      eventDate: "2025-06-12T20:00:00Z",
      location: "Automobile Club du Maroc",
      price: 950,
      imageUrl: "/images/casanola.jpg",
      posterUrl: "/images/casanola.jpg",
      availability: { totalTickets: 500, purchasedCount: 120 },
      position: [33.5731, -7.5898],
    },
    {
      id: "3",
      name: "REMA WORLD TOUR",
      description: "Le superstar nigérian Rema en concert à Casablanca!",
      eventDate: "2025-06-13T21:00:00Z",
      location: "Morocco Mall",
      price: 1200,
      imageUrl: "/images/rema.jpg",
      posterUrl: "/images/rema.jpg",
      availability: { totalTickets: 1000, purchasedCount: 400 },
      position: [33.5731, -7.5898],
    },
      ...
      <main className="min-h-screen flex items-center justify-center">
        <div className="bg-white p-8 rounded shadow text-center">
          ...
          <p className="text-gray-600 mb-4">
            Aucun événement n'a été trouvé pour cet identifiant.
          </p>
    ...
    <main className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      <section className="relative bg-white max-w-7xl mx-auto mt-8 rounded-lg overflow-hidden shadow-lg flex flex-col md:flex-row">
        ...
        <div className="md:flex-1 p-8 flex flex-col justify-center">
          <h1 className="text-4xl font-bold text-[#FF5A1F] mb-4">
            {event.name}
          </h1>
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mt-4">
                            <button
                              className="bg-[#FF5A1F] hover:bg-red-600 text-white px-4 py-2 rounded-lg text-xs font-bold transition-colors flex items-center gap-1 shadow-md"
                              onClick={() =>
                                alert(`Achat simulé : 1 billet pour ${title}`)
                              }
                            >
                              Acheter
                            </button>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg max-h-[420px] overflow-y-auto">
            ...
            <ul className="mt-6 space-y-4 text-gray-700 text-sm">
              <li>
                <strong>Benk Taleb</strong>{" "}
                <em className="text-gray-400">il y a 3 minutes</em>
                <p>Au top, c'était fantastique le gars !</p>
              </li>
              <li>
                <strong>Adam Plume</strong>{" "}
                <em className="text-gray-400">il y a 9 minutes</em>
                <p>Vivement le Morocco Festival !</p>
              </li>
              <li>
                <strong>Malik Enjoy</strong>{" "}
                <em className="text-gray-400">il y a 1 heure</em>
                <p>
                  Really nice vibes, loved it... on ne peut pas rater Rema (lol)
                </p>
              </li>
              <li>
                <strong>Huda Nacer</strong>{" "}
                <em className="text-gray-400">il y a 2 heures</em>
